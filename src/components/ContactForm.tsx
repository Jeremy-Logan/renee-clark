        ...
        <div className="relative px-6 mt-10 py-16 lg:px-8 z-10 bg-stone-100/60 max-w-3xl w-full xl:w-1/3 mx-auto rounded-lg shadow-lg">
            ...
            <form action="#" method="POST" className="mx-auto mt-10 max-w-xl sm:mt-12">
                ...
                <div className="mt-10">
                    <button
                        type="submit"
                        className="block w-full rounded-md bg-[#686666] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#797777] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                        Let&rsquo;s talk
                    </button>
                </div>
